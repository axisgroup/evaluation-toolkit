...
|---|---|---|---|---|
|Icons are not clear, labels needed as well(reported for the Import Convert Upload buttons at the top-center of the interface )| 2 | 0 | 2,3,4 | Effective Menu/Command Structure
