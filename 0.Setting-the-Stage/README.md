...
- To help identify [pitfalls](evaluation-toolkit/0.Setting-the-Stage/Pitfalls.md) in our current evaluation process, so designers can be more cognizant of them and control for them when possible.
